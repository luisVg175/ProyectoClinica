                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Horarios <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="elements.jsp">Horario de atencion</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="Doctors.jsp">Doctores</a></li>
                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="Appointment">
                                    <div class="book_btn d-none d-lg-block">
                                        <a  href="login.jsp">Agendar cita</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
